...
export default function SlackLayout() {
  return (
    <div className="slack-window">
      <div className="h-[700px] w-full max-w-[1200px] flex flex-col rounded-xl border border-[var(--slack-chat-header-border)] slack-3d-passthrough bg-[var(--slack-chat-bg)]">
        ...
        <div className="flex flex-1 min-h-0 slack-3d-passthrough">
          ...
          {/* <div className="slack-layer slack-layer-fade slack-layer-first flex shrink-0 rounded-bl-xl">
            <ActivityBar />
          </div> */}
