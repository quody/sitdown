export default function TopNav() {
  return (
    <div className="flex items-center h-10 bg-[var(--slack-aubergine-dark)] px-2 gap-2 rounded-t-xl"
      ...
      <div className="flex items-center gap-0.5">
        <button className="p-1 rounded hover:bg-[var(--slack-aubergine-hover)] text-black/50 hover:text-black/70"
                aria-label="Back">
        ...
        <button className="p-1 rounded hover:bg-[var(--slack-aubergine-hover)] text-black/20 cursor-not-allowed"
      ...
      {/* Search bar */}
      <button className="flex items-center gap-2 bg-black/5 hover:bg-black/8 rounded-md px-3 h-[26px] min-w-[480px] max-w-[720px] text-black/40 text-sm transition-colors">
        <svg viewBox="0 0 20 20" className="w-4 h-4" fill="currentColor">
