export default function WorkspaceHeader() {
  return (
    <div className="flex items-center justify-between px-4 py-3">
      <button className="flex items-center gap-1 text-[var(--slack-sidebar-text)] font-bold text-[17px] hover:bg-[var(--slack-sidebar-hover)] rounded px-1 -ml-1">
        <span>SitDown</span>
        <svg viewBox="0 0 20 20" className="w-4 h-4 text-white/40" fill="currentColor">
      ...
      <div className="flex items-center gap-1">
        <button className="p-1.5 rounded hover:bg-[var(--slack-sidebar-hover)] text-white/40 hover:text-white/60" aria-label="Settings">
        ...
        <button className="p-1.5 rounded hover:bg-[var(--slack-sidebar-hover)] text-white/40 hover:text-white/60" aria-label="Compose">
          <svg viewBox="0 0 20 20" className="w-4 h-4" fill="currentColor">
